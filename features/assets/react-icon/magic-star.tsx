...
export const MagicStar: React.FC<MagicStarProps> = ({
  size = 18,
  color = '#695ACD',
  className = '',
}) => {
  return (
    <svg
      width={size}
      height={size - 1} // Maintains original aspect ratio (19:18)
      viewBox="0 0 19 18"
      fill="none"
...
// Usage examples:
// <MagicStar /> - Default size (18) and color (#695ACD)
// <MagicStar size={24} color="#FF0000" className="mr-2" />
