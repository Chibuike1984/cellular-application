    ...
    items: [
      {
        icon: NewOrderIcon,
        name: "New Order",
        slug: "/dashboard/Order/new",
      },
      {
        icon: LiveOrderIcon,
        name: "Live Order",
        slug: "/dashboard/order/live-orders",
      },
      {
      ...
      },
      {
        ...
        slug: "/dashboard/order/delivery-management",
      },
    ],
    exact: false,
  },
    ...
    items: [
      {
        ...
        slug: "/dashboard/reservation/table-availability",
      },
      {
      ...
      },
      {
        ...
        slug: "/dashboard/reservation/wishlist-management",
      },
    ],
  },
    ...
    items: [
      {
        icon: CategoryIcon,
        name: "Categories",
        slug: "/dashboard/menu/categories",
      },
      {
        icon: ViewMenuIcon,
        name: "View Menu",
        slug: "/dashboard/menu/list",
      },
    ],
    exact: false,
  },
    ...
    items: [
      {
        icon: CategoryIcon,
        name: "Items",
        slug: "/dashboard/inventory/list",
      },
      {
        icon: BsBarChart,
        name: "Stock Levels",
        slug: "/dashboard/inventory/stock-level",
      },
      {
        icon: LiveOrderIcon,
        name: "Purchase Orders",
        slug: "/dashboard/inventory/purchase-orders",
      },
      {
        icon: ScissorIcon,
        name: "Suppliers",
        slug: "/dashboard/inventory/suppliers",
      },
      {
        icon: WasteTrackIcon,
        name: "Expiry & Waste Tracking",
        slug: "/dashboard/inventory/expiry-&-waste-tracking",
      },
    ],
    exact: false,
  },
...

  {
    ...
    items: [
      ...
      },
      {
        ...
        slug: "/dashboard/staff/shift-scheduling",
      },
      {
        icon: LiveOrderIcon,
        name: "Payroll & Attendance",
        slug: "/dashboard/staff/payroll-&-attendance",
      },
      {
        icon: ScissorIcon,
        name: "Staff Performance",
        slug: "/dashboard/staff/staff-performance",
      },
    ],
    exact: false,
  },
    ...
    items: [
      {
        icon: ReceiptIcon,
        name: "Sales Invoices ",
        slug: "/dashboard/financial/sale-invoices",
      },
      {
        icon: BsBarChart,
        name: "Payments & Transactions",
        slug: "/dashboard/financial/payments-&-transactions",
      },
      {
        icon: LiveOrderIcon,
        name: "Expense Tracking",
        slug: "/dashboard/financial/expense-tracking",
      },
      {
        icon: ScissorIcon,
    ...
    items: [
      {
        icon: EmployeeDirectoryIcon,
        name: "Sales Reports",
        slug: "/dashboard/analytics/sales-reports",
      },
      {
        icon: BsBarChart,
        name: "Inventory Analysis",
        slug: "/dashboard/analytics/inventory-analysis",
      },
      {
        icon: LiveOrderIcon,
        name: "Customer Insights",
        slug: "/dashboard/analytics/customer-insights",
      },
      {
        icon: ScissorIcon,
        name: "Staff Performance",
        slug: "/dashboard/analytics/staff-performance",
      },
    ],
    exact: false,
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        slug: "/dashboard/customer/feedback-&-review",
      },
    ],
    exact: true,
  },
